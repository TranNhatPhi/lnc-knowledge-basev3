...
source_id: aaip_express_entry_eligibility
source_url: https://www.alberta.ca/aaip-alberta-express-entry-stream-eligibility
topic: eligibility
version: '1.0'
---
...
In 2024 and early 2025, the AAIP will consider an invitation to apply based on the following priorities:
  * [Dedicated Health Care Pathway](https://www.alberta.ca/dedicated-health-care-pathway "Dedicated Health Care Pathway")
  * Accelerated Tech Pathway
  * Law Enforcement Pathway
  * priority sectors, such as construction, agriculture, aviation
...
The following minimum assessment requirements apply to all Alberta Express Entry Stream applicants at the time of application and assessment:
    ...
    * you meet the criteria of at least one of the federal immigration programs managed by Express Entry:
      ...
      * [Federal Skilled Trades Program](https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/eligibility/skilled-trades.html)
    ...
    * you must have a minimum Comprehensive Ranking System score of 300
    * your primary occupation in your federal Express Entry profile must be included as part of a specific Express Entry stream pathway, or is identified as an occupation connected to a provincial economic, sector or occupational priority
    * you and your Alberta employer must meet all the requirements outlined on [Alberta Job Offer and Employment Requirements,](https://www.alberta.ca/job-offer-and-employer-requirements "Job offer and employer requirements") if you are invited based on having an Alberta job offer
...
You are not eligible to apply if:
    * your primary occupation is on the [Alberta Opportunity Stream Ineligible Occupations list](https://www.alberta.ca/node/680#occupation-requirements)
...
The Dedicated Health Care Pathway page sets out eligibility requirements for this pathway.
    * You must review the [Dedicated Health Care Pathway](https://www.alberta.ca/dedicated-health-care-pathway "Dedicated Health Care Pathway") page before submitting an application.
#### Accelerated Tech Pathway
...
At the time your application is submitted and assessed:
    * you must be working full-time in Alberta under an employment contract or have a bona fide job offer signed by you and your employer that:
      * meets job offer and current employment contract requirements identified on the [Alberta job offer requirements page](https://www.alberta.ca/job-offer-and-employer-requirements "Job offer and employer requirements"), and:
        * is in an occupation on the [list of eligible Accelerated Tech Pathway occupations](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-tech-pathway-nocs-codes-list.pdf "lbr-aaip-tech-pathway-nocs-codes-list.pdf")
        * is for an Alberta employer whose primary business activities belong to the Alberta tech industry, as defined by the [AAIP list of eligible North American Industry Classification System (NAICS) codes](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-tech-pathway-naics-codes-list.pdf "lbr-aaip-tech-pathway-naics-codes-list.pdf")
...
At the time your application is submitted and assessed:
    * your primary occupation in your Express Entry profile must be an eligible construction, agriculture or aviation occupation
    * if you are invited based on having an Alberta job offer, your job offer occupation must be an eligible construction, agriculture or aviation occupation
...
To confirm selection parameters, review information on selection draws completed by the AAIP on [AAIP processing information.](https://www.alberta.ca/aaip-processing-information "Alberta Advantage Immigration Program – Processing information")
...
If you submitted your Alberta Express Entry application on or after September 30, 2024, and your Express Entry Profile expires before a decision is made on your application, you can now submit an updated profile. You may update your Express Entry Profile in the following ways:
    * The AAIP may request that you create and submit a new Express Entry Profile that meets AAIP requirements (CRS of 300 or more, and the same primary occupation as listed in your Worker Expression of Interest).
    * You can also proactively submit an updated Express Entry Profile through the AAIP portal under the “Update Employment Information” tab if you realize that your current profile has expired or is about to expire before a decision is made on your application. Your new Express Entry Profile must meet the AAIP requirements.