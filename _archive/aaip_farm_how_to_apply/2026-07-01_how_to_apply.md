...
source_id: aaip_farm_how_to_apply
source_url: https://www.alberta.ca/aaip-farm-stream-how-to-apply
topic: process
version: '1.0'
---
...
If you decide to request the withdrawal of an application, submit your request using the [Opportunity Alberta contact form](https://www.alberta.ca/contact-opportunity-alberta "Contact Opportunity Alberta").
...
Before you consider applying to this stream, you are strongly encouraged to review the following [AAIP Business Plan (Guidelines)](https://www.alberta.ca/system/files/im-aaip-business-plan-guidelines.pdf "im-aaip-business-plan-guidelines.pdf") to assist you with preparing your business plan.
...
Download and use the [AAIP Farm Stream Document Checklist](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-farm-stream-checklist.pdf "lbr-aaip-farm-stream-checklist.pdf") to complete your application. The checklist lists all the forms required for your application.
You must complete the following **original** forms with **original** signatures:
  * [Farm Stream Application](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-farm-stream-application-form.pdf "lbr-aaip-farm-stream-application-form.pdf")


You must complete and provide **copies** of the following Immigration, Refugees and Citizenship Canada (IRCC) forms:
  * [IMM 0008 Generic Application Form for Canada](https://www.canada.ca/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm0008enu_2d.pdf)
  * [IMM 0008 Schedule 4: Economic Classes: Provincial Nominees](https://www.canada.ca/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm0008_4e.pdf)
  * [IMM 0008 Schedule 4A: Economic Classes: Business Nominees](https://www.canada.ca/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm0008_4ae.pdf)
  * [IMM 0008DEP Additional Dependents/Declaration Form](https://www.canada.ca/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm0008depenu.pdf)
...
The following IRCC forms must be completed by you, your spouse/common-law partner and any dependents over the age of 18:
  ...
  * [IMM 5476 Use of a Representative](https://www.canada.ca/content/dam/ircc/migration/ircc/english/pdf/kits/forms/imm5476e.pdf) (if applicable)


For help in filling out IRCC forms, read the [IRCC Guide for Provincial Nominees](https://www.canada.ca/en/immigration-refugees-citizenship/services/application/application-forms-guides/guide-p7000-application-permanent-residence-provincial-nominee-class.html).
### Step 4. Pay the application fee
All Farm Stream applications paid for on or after April 1, 2024, are subject to a fee of $3,500.
Email entrepreneur.supportservice@gov.ab.ca for instructions on how to pay application processing fee.
...
#### Online payment
Follow the instructions provided by the entrepreneur.supportservice@gov.ab.ca to submit payment. Once payment is made, you will receive an email with your fee payment receipt.
...
For any online fee payment issues, contact the [eServices](https://eservices.alberta.ca/contact/).
...
Farm StreamAlberta Advantage Immigration Programc/o Service Alberta and Red Tape Reduction MailroomCommerce Place, 10155 102 StreetEdmonton, Alberta T5J 1S6Canada
Applications by email or fax are not accepted.
## After you apply
### Notification of application
Emails from the AAIP will always come from an @gov.ab.ca account. The Alberta government does not use email accounts such as Gmail, Hotmail, Yahoo, etc. If you receive a suspicious email, contact your local police and report the incident to the AAIP using the [Opportunity Alberta contact form](https://www.alberta.ca/contact-opportunity-alberta "Contact Opportunity Alberta").
...
If you need to make changes or updates to your application after it is submitted but before you are contacted by a program officer with the AAIP, you must submit your request detailing the changes using the [Opportunity Alberta contact form](https://www.alberta.ca/contact-opportunity-alberta "Contact Opportunity Alberta").
...
#### Forms to notify the AAIP of updates
  ...
  * A signed [Use of Representative form](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-candidate-representative-form.pdf "lbr-aaip-candidate-representative-form.pdf") must be provided to change your third-party representative for your AINP application
...
Learn more about what to do [after you are nominated](https://www.alberta.ca/aaip-farm-stream-after-you-are-nominated).
...
Note: All requests for reconsideration paid for on or after April 1, 2024, are subject to a service fee of $250. Requests paid before April 1, 2024, are subject to a $100 fee. Information on how to pay the fee is provided below.
...
Download and fill out the [Request for Reconsideration form](https://www.alberta.ca/system/files/lbr-aaip-request-for-reconsideration-form.pdf "lbr-aaip-request-for-reconsideration-form.pdf").
#### Step 2. Pay the fee
...
**Online Payment**
Email entrepreneur.supportservice@gov.ab.ca for instructions on how to pay the request for reconsideration processing fee. Once fees are paid, you will receive an email with your fee payment receipt.
Make a copy of your fee payment receipt.
For any online fee payment issues, contact the [eServices](https://eservices.alberta.ca/contact/).
#### Step 3. Submit your request
Email your completed Request for Reconsideration form, with supporting documents and a copy of your fee payment receipt to the program officer who issued your nomination.
...
## Forms and documents
  * [Farm Stream application](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-farm-stream-application-form.pdf "lbr-aaip-farm-stream-application-form.pdf")
  * [Change of Contact and Address Information form](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-change-contact-information-form.pdf "lbr-aaip-change-contact-information-form.pdf")
  * [Farm Stream Document Checklist](https://www.alberta.ca/system/files/custom_downloaded_images/lbr-aaip-farm-stream-checklist.pdf "lbr-aaip-farm-stream-checklist.pdf")
  * [Request for Reconsideration form](https://www.alberta.ca/system/files/lbr-aaip-request-for-reconsideration-form.pdf "lbr-aaip-request-for-reconsideration-form.pdf") - for paper applications only
  * [Request to Add or Remove Family Member(s)](https://www.alberta.ca/system/files/im-aaip-add-remove-family-member-form.pdf "im-aaip-add-remove-family-member-form.pdf")
